let cookies = {
  // av
  "video.fc2.com": [
    { domain: "video.fc2.com", path: "/", name: "_ac", value: "1" }
  ],
  "amiami.jp": [
    { domain: "amiami.jp", path: "/", name: "age_confirm", value: "true" }
  ],
  "oshiete.goo.ne.jp": [
    { domain: "oshiete.goo.ne.jp", path: "/", name: "adult_filter", value: "1" }
  ],

  // general sites
  "dlsite.com": [
    { domain: "dlsite.com", path: "/", name: "adultchecked", value: "1" }
  ],
  "nijiyome.jp": [
    { domain: "nijiyome.jp", path: "/", name: "adultcheck", value: "1" }
  ],
  "melonbooks.co.jp": [
    { domain: "melonbooks.co.jp", path: "/", name: "AUTH_ADULT", value: "1" }
  ],
  "s-cute.com": [
    { domain: "s-cute.com", path: "/", name: "over18", value: "1" }
  ],
  "getchu.com": [
    {
      domain: "getchu.com",
  ...
  "yodobashi.com": [
    ...
    },
    {
      domain: "yodobashi.com",
      path: "/",
      name: "contentFilterLevelValue",
      value: "2"
    }
  ],
  "dmm.co.jp": [
    { domain: "dmm.co.jp", path: "/", name: "setover18", value: "1" }
  ],
  "mgstage.com": [
    { domain: "mgstage.com", path: "/", name: "adc", value: "1" }
  ],
  "dmm.com": [{ domain: "dmm.com", path: "/", name: "ckcy", value: "1" }],
  "gyutto.com": [
    { domain: "gyutto.com", path: "/", name: "adult_check_flag", value: "1" }
  ],
  "digiket.com": [
    { domain: "digiket.com", path: "/", name: "adult_check", value: "1" }
  ],
  "toranoana.jp": [
    { domain: "toranoana.jp", path: "/", name: "afg", value: "0" }
  ], //とらのあな
  "ura-akiba.jp": [
    { domain: "ura-akiba.jp", path: "/", name: "auth", value: "1" }
  ], //うらあきば.じぇいぴ～
  "syosetu.com": [
    { domain: "syosetu.com", path: "/", name: "over18", value: "yes" }
  ],
  "booth.pm": [{ domain: "booth.pm", path: "/", name: "adult", value: "t" }],
  "digbook.jp": [
    { domain: "digbook.jp", path: "/", name: "adult_check", value: "true" }
  ],

  // brands sites
  "s-mi-le.com": [
    { domain: "s-mi-le.com", path: "/", name: "modal", value: "off" }
  ], // スミレ
  "www.web-marmalade.com": [
    { domain: "www.web-marmalade.com", path: "/", name: "modal", value: "off" }
  ]
    ...
    if (matchedDomain) {
      ...
      if (cookieHeader) {
        for (let i = 0; i < matchedDomain.length; i++) {
          if (
            !cookieHeader.match(
              new RegExp(`(^|;|\\s)${matchedDomain[i].name}=`)
            )
          ) {
